...
class AppleSignInModal:
    ...
    def __init__(self):
        ...
        self.user_email = "doctor@icloud.com"
        self.masked_email = "d***r@icloud.com"
    ...
    def draw_initial_state(self, screen, modal_y):
        ...
        app_text = FONT_BODY.render("Health Admin wants to use", True, GREY)
    ...
    def draw_loading_state(self, screen, modal_y):
        ...
        for i in range(8):
            ...
            pygame.draw.circle(dot_surface, (0, 0, 0, max(50, alpha)), (6, 6), 6)
