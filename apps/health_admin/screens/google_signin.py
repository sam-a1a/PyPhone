...
class GoogleSignInModal:
    ...
    def __init__(self):
        self.state = "initial"  # initial, accounts, loading, success
        ...
        self.accounts = [
            {"name": "Dr. Jihan Admin", "email": "jihan@demo.com", "avatar_color": BLUE},
            {"name": "Dr. Sarah Johnson", "email": "sarah.johnson@hospital.com", "avatar_color": PURPLE},
        ]
    ...
    def draw(self, screen):
        ...
        # Draw modal with rounded top corners
    ...
    def draw_google_logo_fallback(self, screen, x, y, size=40):
        """Draw Google logo fallback if image not available."""
    ...
    def draw_initial_state(self, screen, modal_y):
        ...
        # Subtitle
        subtitle = FONT_BODY.render("to continue to Health Admin", True, GREY)
        ...
        for i, account in enumerate(self.accounts):
            ...
            initial = account["name"].split()[-1][0].upper() if "Dr." in account["name"] else account["name"][0].upper()
        ...
        privacy2 = FONT_SMALL.render("email, and profile picture with Health Admin.", True, GREY)
    ...
    def draw_accounts_state(self, screen, modal_y):
        """Draw account selection (same as initial)."""
        self.draw_initial_state(screen, modal_y)
